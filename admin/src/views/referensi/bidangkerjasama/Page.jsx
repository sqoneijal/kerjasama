...
export default function Page() {
   ...
   const handleEdit = (e) => {
      ...
      navigate("/referensi/bidangkerjasama/forms");
   };
   ...
   const handleDelete = async (id) => {
      Swal.fire({
         ...
         if (result.isConfirmed) {
            const res = await post("/referensi/bidangkerjasama/hapus", { id }, { headers: { ...init.token } });
   ...
   useLayoutEffect(() => {
      dispatch(
         setModule({
            ...
            pageButton: {
               variant: "primary",
               label: "Tambah Data",
               href: "/referensi/bidangkerjasama/forms",
            },
         })
      );
      ...
      const grid = new Grid({
         ...
         server: {
            url: `${window.apiUrl}/referensi/bidangkerjasama/getdata`,
            then: (data) => data,
            headers: { ...init.token },
         },
         search: false,
