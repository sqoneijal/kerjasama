...
export default function Page() {
   ...
   const handleDelete = async (id) => {
      Swal.fire({
         ...
         if (result.isConfirmed) {
            const res = await post("/referensi/mou/hapus", { id }, { headers: { ...init.token } });
   ...
   useLayoutEffect(() => {
      ...
      const grid = new Grid({
         ...
         server: {
            url: `${window.apiUrl}/referensi/mou/getdata`,
            then: (data) => data,
            handle: async (res) => {
