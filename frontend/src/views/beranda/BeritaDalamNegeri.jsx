...
const BeritaDalamNegeri = () => {
   ...
   useLayoutEffect(() => {
      if (typeof module.dalamNegeri !== "undefined") {
         const sorted = [...module.dalamNegeri].sort((a, b) => new Date(b.create_at) - new Date(a.create_at));
   ...
   return (
      <div className="post-inner">
         <div className="align-items-center d-flex post-head">
            <h2 className="title">
               <strong>Berita</strong> Dalam Negeri
            </h2>
         </div>
         <div className="post-body">
            {typeof module.dalamNegeri !== "undefined" && (
               <Row>
         ...
         <div className="post-footer">
            <Row className="thm-margin">
               <Col md={12} className="thm-padding">
                  <Link to={`/berita/jenis/dalamnegeri`} className="more-btn">
                     Lainnya Berita Dalam Negeri
                  </Link>
               </Col>
            </Row>
         </div>
...
export default BeritaDalamNegeri;
